...
//             <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Awesome Features for Young Coders</h2>
//             <p className="text-lg text-gray-600">Discover all the amazing tools and features that make learning Python fun and exciting!</p>
//           </div>
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pl-[6rem]">
//             {/* Feature Cards */}
//             <div className="group bg-white p-8 rounded-2xl border border-neutral-200/20 hover:border-indigo-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
...
//                 </svg>
//               </div>
//               <h3 className="text-xl font-semibold text-gray-900 mb-3">Interactive Lessons</h3>
//               <p className="text-gray-600">Learn Python step-by-step with fun examples and interactive challenges.</p>
//             </div>
