...
// const McqComponent = () => {
//   const [mcqs, setMcqs] = useState<Array<{ question: string; options: string[]; correctAnswer: string }>>([]);
...
//       setReward("🎉 Hurray! You got all answers correct! Here's a gold star: ⭐");
...
//   return (
//     <div className="flex flex-col items-center p-6 bg-neutral-900 text-white rounded-lg">
//       <h1 className="text-3xl font-bold mb-6">Python MCQs for Kids 🐍</h1>

//       {error && (
//         <div className="w-full bg-red-600 p-4 rounded-lg mb-4">
...
//       {mcqs.length > 0 ? (
//         mcqs.map((mcq, index) => (
//           <div key={index} className="w-full bg-neutral-800 p-6 rounded-lg shadow mb-4">
//             <h2 className="text-xl font-semibold mb-4">{mcq.question}</h2>
...
//           className="w-full bg-indigo-600 text-white py-3 rounded mt-4 disabled:bg-indigo-400"
...
//       {/* Results */}
//       {isSubmitted && (
//         <div className="w-full bg-neutral-800 p-6 rounded-lg shadow mt-4">
