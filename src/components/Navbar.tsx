...
// const Navbar = () => {
//   return (
//     <nav className="hidden lg:flex flex-col w-64 h-screen bg-white border-r border-neutral-200/20 fixed ">
...
//         <Link href="#hero" className="flex items-center px-6 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-all duration-300 active">
//           <span>Home</span>
//         </Link>
//         <Link href="#about" className="flex items-center px-6 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-all duration-300">
//           <span>About</span>
//         </Link>
//         <Link href="#features" className="flex items-center px-6 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-all duration-300">
//           <span>Features</span>
//         </Link>
//         <Link href="#how" className="flex items-center px-6 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-all duration-300">
//           <span>Process</span>
//         </Link>
//         <Link href="#testimonials" className="flex items-center px-6 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-all duration-300">
//           <span>Reviews</span>
//         </Link>
//       </div>
...
//             <p className="text-xs text-gray-500">help@pykids.ai</p>
//           </div>
//         </div>
//       </div>
//     </nav>
